...
"needed for the debugger - need to run :GoInstallBinaries to load everything
Plug 'fatih/vim-go'
...
"Plugin - Language Server Protocol Config - vim-vsnip
"-----------
...
"need ripgrep to make work install with: sudo apt-get install ripgrep
